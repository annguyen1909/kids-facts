...
One of their most iconic adaptations is their countershading camouflage. The dorsal (top) side of the shark is a slate gray or brownish hue, blending seamlessly with the dark [ocean](/habitats/ocean) depths when viewed from above. Conversely, their ventral (belly) side is stark white, rendering them virtually invisible against the sunlit surface when viewed from below. This allows them to approach unsuspecting prey completely undetected.
